...
public class ProjectTableModel extends AbstractTableModel {
	  ...
	  List<Project> projectResultList;   // stores the model data in a List collection of type CourseList
	 ...
	 public void addRow(Object[] array,int index) {
		...
		Project newRecord = projectService.createProject((String) array[0], (String) array[1], (String) array[2], (String) array[3], (String) array[4],(String) array[5]);
	 ...
	 public void deleteRow(int index) {
		...
		Project newRecord;
              newRecord = projectService.updateProject(index,(String) array[0], (String) array[1], (String) array[2], (String) array[3], (String) array[4], (String) array[5]);
		userTransaction.commit();
		 
        int row;  
        System.out.println("get value of index"+index);
              newRecord= projectResultList.set(index, newRecord); 
